...
const cardData = [
  {
    ...
    bulletPoints: ['Worked with multi-displinary teams comprising engineers, designers and customer success to deliver product tailored to individual client needs.',
...

{
  ...
  bulletPoints: ['JS Stack: PostgreSQL | Sequelize ORM | Express.js/REST | Node | React | Redux | Heroku', 'Built CRUD Apps. Built https://github.com/paulpaulx1/aether'],
},
{
  ...
  bulletPoints: ['High end residential interior builds in and around NYC.', 'Responsible for color matching, spray finishing and installation of six/seven-figure woodworking jobs.'],
},
{
  title: 'PopChart - Woodshop Manager',
  date: '2013-2018',
  location: 'Greenpoint Brooklyn, NY',
  summary: 'Shop Floor Manager',
  imageUrl: 'woodshop.png',
  bulletPoints: ['Poster design company. I managed the manufacturing of picture frames and various other wooden objects for five years here.', 'Trained 40+ employees in basic woodworking. Safety first. Oversaw crews of 4-10 people.', 'Maintained machinery, spray booth, built stuff out of wood and sprayed it with paint and lacquer.'],
},
{
